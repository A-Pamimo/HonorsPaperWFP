...
\author{Alirah Weyori, Nicole Wu, and Mohamed Salem}
\date{\today}
\title{Assessing household food security in emergencies, does remote data collection cover the gap?}
...
Measuring and reporting global food insecurity is as crucial as addressing the phenomenon itself. However, during emergencies, when reliable and evidence-based food security indicators are needed, it proves difficult to collect data through conventional Face-to-Face (F2F) interviews due to limited field access and security considerations. This has over time created a data gap for food security analysis. With the global surge in mobile and internet access, remote data collection is seen as an important way to bridge the growing data gap in food security analysis. Employing a survey experiment with a stratified sample, this study uses household data from two countries to validate the remote Consolidated Approach for Reporting Indicators of Food Insecurity (rCARI). Comparing the results with the standard Consolidated Approach for Reporting Indicators of Food Insecurity (CARI) methodology reveals two key conclusions. First, rCARI tends to be context-specific. Second, rCARI tends to be conservative relative to CARI by reporting lower food insecurity prevalence. WHile these results show promise in using the remote modules to communicate food insecurity, further empirical studies are needed to fine tune some of the indicators to better align with the standard CARI.\\ 		\\ \textbf{Keywords: Food security, remote, income, expenditure, food consumption score, CARI}
...
Food insecurity continue to rise globally posing a significant threat to lives, peace and order. According to the recently publish food security numbers,  Measuring food security poses methodological challenges, particularly for organizations operating in populations experiencing food insecurity. Complex data collection and analysis are often impractical, especially in emergency situations (Smith, 2018; Jones et al., 2020). Across various methods, a common practice is the utilization of primary household data gathered through face-to-face interviews or surveys. However, recent events, such as the Covid-19 pandemic and its associated restrictions on movement and physical contact, have significantly hindered conventional data collection approaches. Consequently, the ability to assess the food security needs of populations has been greatly compromised due to the lack of reliable and readily available data (Brown, 2020; White et al., 2021).
