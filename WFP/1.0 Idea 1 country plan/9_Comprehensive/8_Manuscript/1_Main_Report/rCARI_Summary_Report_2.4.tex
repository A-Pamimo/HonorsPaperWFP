...
In the next steps, a further in-depth analysis of the data will be conducted to better understand the differences between the results of the modalities, including potential drivers. Additionally, efforts will be made to harmonize and standardize the income source and income change indicators to be used in food security assessments and reporting.
