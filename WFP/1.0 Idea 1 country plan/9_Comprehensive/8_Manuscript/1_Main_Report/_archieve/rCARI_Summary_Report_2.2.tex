...
\SetWatermarkText{FOR INTERNAL WFP CIRCULATION ONLY}
\SetWatermarkFontSize{5cm}
\SetWatermarkScale{0.25}
\SetWatermarkColor[gray]{0.45}
\usepackage{amsmath}
\usepackage{setspace}
\usepackage{url}
...
In the next steps, further in-depth analysis of the data collected will be conducted to better understand and standardize the income source and income change indicator to be used in food security assessments and reporting . While digging deeper into the analysis, plans are far advanced to resume data collection in the remaining pilot countries – Burkina Faso, Lebanon \& Guatemala.
...
\begin{itemize}[label=--, left=2.75em]
	\item[1.] Resume data collection in the remaining study countries – Burkina Faso, Lebanon (or Iraq) \& Guatemala.
