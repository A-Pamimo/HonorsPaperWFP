...
*******************************************************************************/
	...
	use "${dta}/Myanmar_Full_Household_Analysis.dta", replace
	compress 
	
	** 1 Survey Completion	
	eststo  clear
	estpost tabulate S_Assign_Modality Completion
	esttab using "${tex_tab}/Myanmar_rCARI_Completion.tex", 					///
...
*******************************************************************************/
	...
	compress
	save "${dta}/Myanmar_Full_Household_rCARI_Analysis.dta", replace
