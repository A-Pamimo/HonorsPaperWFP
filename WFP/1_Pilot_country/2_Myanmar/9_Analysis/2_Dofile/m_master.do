...
* change 0 to 1 to select do-file to run
	...
	local   gender			1 	// Run gendered analysis
...
*			
* 	CREATES:	${dta}/Myanmar_Full_Household_Analysis_rCARI.dta
*
* ------------------------------------------------------------------------------
	
	if `organize'		do "${dofile}/m01_Organize.do"
...
* ------------------------------------------------------------------------------	
	...
	if `balance'		do "${dofile}/m02_Balance.do"
...
* ------------------------------------------------------------------------------	
	...
	if `gender'			do "${dofile}/m04_Gender.do"
...
* ------------------------------------------------------------------------------	
	...
	if `excel'			do "${dofile}/m99_Excel.do"
