...
*******************************************************************************/
	...
	* load dataset
	use "${hfc_temp}/BF_F2F_Household_Prep.dta", clear 
...
** Outcome: Household food security status 
	/*ren _v1 RESPPercFoodSec_1
	ren _v2 RESPPercFoodSec_2
	ren _v3 RESPPercFoodSec_3
	ren _v4	RESPPercFoodSec_4
	*/
...
local  lcs  stress_DomAsset stress_HealthEdu stress_Saving 				///
			stress_BorrowCash crisis_ProdAssets crisis_DomMigration		///
			crisis_ChildWork em_ResAsset em_Begged em_FemAnimal
...
egen HHExp_NonFood_GiftAid_MN_6M = rowtotal(HHExpNFMedServ_GiftAid_MN_6M 	///
	 ...
	 HHExpNFCloth_GiftAid_MN_6M_S HHExpNFEduFeeGood_GiftAid_6M_S			///
	 HHExpNFRent_GiftAid_MN_6M_S HHExpNFHHSoftMaint_GiftAid_6M_S)
...
foreach var of global income {
	...
	gen 	HHIncFirst_Accept = inlist(HHIncFirst_SRi, 1, 2, 5, 12, 13, 14, 15, 16)
	replace HHIncFirst_Accept = 1 if HHIncFirst_oth == "Production agricole" | ///
			HHIncFirst_oth == "Apiculture" 	| ///
			HHIncFirst_oth == "Plantation"  | ///
			HHIncFirst_oth == "Le commence" | ///
			HHIncFirst_oth == "Commerce" 	| ///
			HHIncFirst_oth == "Le Commerce"| ///
			HHIncFirst_oth == "Agriculture"	| ///
			HHIncFirst_oth == "Élevage"     | ///
			HHIncFirst_oth == "ÉLevage"     | ///
			HHIncFirst_oth == "Petite Production Agricole Uniquement" | ///
			HHIncFirst_oth == "Production Agricole" | ///
			HHIncFirst_oth == "Vdp"			| ///
			HHIncFirst_oth == "Maitre Coranique" | ///
			HHIncFirst_oth == "Producteur De Cacao" | ///
			HHIncFirst_oth == "DolotièRe" | ///
			HHIncFirst_oth == "Fonctionnaires D'éTat"| ///
			HHIncFirst_oth == "Dolotier"
			
			
	gen		HHIncFirst_Border = inlist(HHIncFirst_SRi, 3, 4, 6, 11)
	replace HHIncFirst_Border = 1 if HHIncFirst_oth == "Orpaillage" | ///
			HHIncFirst_oth == "orpallage" 	| ///
			HHIncFirst_oth == "Orpailleur"  | ///
			HHIncFirst_oth == "Forgeron" 	| ///
			HHIncFirst_oth == "Couturier" 	| ///
			HHIncFirst_oth == "Orpailleurs" | ///
			HHIncFirst_oth == "Forgeron" 	| ///
			HHIncFirst_oth == "Réparateur De torches" | ///
			HHIncFirst_oth == "Asc"| ///
			HHIncFirst_oth == "Orpallage"| ///
			HHIncFirst_oth == "Orpaillage Artisanal"| ///
			HHIncFirst_oth == "Réparateur de torches" | ///
			HHIncFirst_oth == "MaçOn" | ///
			HHIncFirst_oth == "RéParateur De Torches" | ///
			HHIncFirst_oth == "L'Or" | ///
			HHIncFirst_oth == "MéCanicien" | ///
			HHIncFirst_oth == "Vent De Bois" | ///
			HHIncFirst_oth == "Vente De BéTail" | ///
			HHIncFirst_oth == "Vente D'Herbe" | ///
			HHIncFirst_oth == "Tissage De Panier" | ///
			HHIncFirst_oth == "Confection De Panier" | ///
			HHIncFirst_oth == "MéCanique" | ///
			HHIncFirst_oth == "Orpaillage" | ///
			HHIncFirst_oth == "Orpalleur" | ///
			HHIncFirst_oth == "Artisant" | ///
			HHIncFirst_oth == "Vent De Bois" | ///
			HHIncFirst_oth == "Ramassage De Gravillons" | ///
			HHIncFirst_oth == "Orpaleur" 
			
		
	
	gen 	HHIncFirst_Poor	  = inlist(HHIncFirst_SRi, 7, 8, 9, 10)
	replace HHIncFirst_Poor   = 1 if HHIncFirst_oth == "ramassage de gravillons" | ///
			HHIncFirst_oth == "Orpailleurs Et D Autre Travail Non Fixe" | ///
			HHIncFirst_oth == "Pas De Travail Fixe" | ///
			HHIncFirst_oth == "Pas Se Travail Fixe" | ///
			HHIncFirst_oth == "Gardiennage" | ///	
			HHIncFirst_oth == "JardinièRe" | ///
			HHIncFirst_oth == "Jardinage"
	...
	** Question relevant when: ${HHIncNb} >0
	...
	gen HHInc_Trade 		= (HHIncFirst_SRi == 11 | HHIncFirst_SRi == 12 | ///
							   HHIncFirst_SRi == 13)
	gen HHInc_AgProduction 	= (HHIncFirst_SRi == 14 | HHIncFirst_SRi == 15| HHIncFirst_SRi ==16)
...
*******************************************************************************/	
	...
	label var HHDisabledNb			"Number of disabled household members"
...
*******************************************************************************/
	...
	labelrename labels149 HHExpFPro_Purch_7D_S
	labelrename labels189 HHExpNFHHSoft_GiftAid_6M_S
	labelrename labels150 HHExpFPro_GiftAid_7D
	labelrename labels185 HHExpNFEdu_GiftAid_6M_S
	labelrename labels151 HHExpFPro_Own_7D_S
	labelrename labels181 HHExpNFMed_GiftAid_6M_S
	labelrename labels167 HHExpNFTrans_GiftAid_1M_S 
	
	iecodebook export using "${hfc_note}/BF_F2F_Codebook.xlsx", replace
	
	save "${hfc_temp}/BF_F2F_Household_Analysis.dta", replace	
