...
*******************************************************************************/
	...
	* load dataset
	use "${d_temp}/BKF_F2F_Household_Prep.dta", clear 
...
foreach var of global income {
	...
	replace HHIncFirst_Accept = 1 if HHIncFirst_oth == "Agriculture" | ///
			...
			HHIncFirst_oth == "Agent de Santé Communautaire" | ///
			HHIncFirst_oth == "Agriculture" 
	
	gen		HHIncFirst_Border = inlist(HHIncFirst_SRi, 3, 4, 6, 11)
	replace HHIncFirst_Border = 1 if HHIncFirst_oth == "Réparateur de torches" | ///
	...
	replace HHIncFirst_Poor   = 1 if HHIncFirst_oth == "Pas de travail fixe" | ///
...
*	iecodebook export using "${d_out}/CAR_F2F_Codebook.xlsx", replace
	...
	save "${d_temp}/BKF_F2F_Household_Analysis.dta", replace	
