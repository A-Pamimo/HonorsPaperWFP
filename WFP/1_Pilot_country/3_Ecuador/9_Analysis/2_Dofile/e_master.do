...
* change 0 to 1 to select do-file to run
	...
	local   excel 			0 	// Create result tables in Excel
...
*			
* 	CREATES:	${dta}/Ecuador_Full_Household_Analysis_rCARI.dta
*
* ------------------------------------------------------------------------------
	
	if `organize'		do "${dofile}/e01_Organize.do"
...
* ------------------------------------------------------------------------------	
	...
	if `balance'		do "${dofile}/e02_Balance.do"
...
* ------------------------------------------------------------------------------	
	...
	if `gender'			do "${dofile}/e04_Gender.do"
...
* ------------------------------------------------------------------------------	
	...
	if `excel'			do "${dofile}/e99_Excel.do"
