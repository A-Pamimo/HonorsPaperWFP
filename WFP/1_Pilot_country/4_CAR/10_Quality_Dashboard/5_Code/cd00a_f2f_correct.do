...
* load dataset
* ---------------	
	use "${d_raw}/CAR_F2F_Household_Raw.dta", clear
	compress
...
*	isid HHID 
	...
	*	iecompdup 	 HHID, id() didifference
	ieduplicates HHID using "${note}/CAR_F2F_DuplicateID_`cdate'.xlsx", 		///
...
*************************  ADD CORRECTION LINES HERE ***************************
	...
	compress
	save "${d_temp}/CAR_F2F_Household_Correct.dta", replace
