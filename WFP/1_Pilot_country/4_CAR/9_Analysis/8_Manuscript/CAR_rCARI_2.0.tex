...
Table 10 presents the results of the rCSI module for the three subsamples. The results show that consistently, households reported higher rCSI (2.9 points amongst the phone owners' group, 3.95 in the non-phone owners and 3.52 in the combined sample respectively) over the phone. This trend is further reflected in classifying more respondents as being food secure (rCSI severe category). The difference is mainly driven by more households over the phone restricting adult food consumption, reducing meals per day and meal sizes eaten.
