...
********************************************************************************
	...
	if `sample_prep'	do "${d_dofile}/cd00_sample_prep.do"
...
* ------------------------------------------------------------------------------
	...
	if `correct'		do "${d_dofile}/cd00a_f2f_correct.do"
	if `correct'		do "${d_dofile}/cd00b_roster_correct.do"
	if `correct'		do "${d_dofile}/cd00c_rm_correct.do"
...
* ------------------------------------------------------------------------------
	...
	if `setup'			do "${d_dofile}/cd01_setup_roster.do"
...
* ------------------------------------------------------------------------------
	...
	if `organize'		do "${d_dofile}/cd02a_f2f_organize.do"
	if `organize'		do "${d_dofile}/cd02b_rm_organize.do"
...
* ------------------------------------------------------------------------------	
	...
	if `append'			do "${d_dofile}/cd03_append.do"
...
* ------------------------------------------------------------------------------	
	...
	if `hfc_sum'		do "${d_dofile}/cd04_hfc_sum.do"
