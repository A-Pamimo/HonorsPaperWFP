...
*******************************************************************************/
	...
	iebaltab ${out_mddi} if Modality == 1, grpvar(RESPSex)   					///
             ...
             rowvarlabels savetex("${tex_tab}/Myanmar_F2F_MDD_Gender.tex")
...
*******************************************************************************/
	...
	graph export "${tex_fig}/Myanmar_F2F_MDD_Index_FCG_Gender.png", replace
...
/*	graph box MDD_Index, over(RESPSex)  						///
    ...
    graph export "${figs_tex}/Myanmar_F2F_MDD_Index_Gender.png", replace
...
*/	
	...
	graph export "${tex_fig}/Myanmar_F2F_MDD_Group_Gender.png", replace
